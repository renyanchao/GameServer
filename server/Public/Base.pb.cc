...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::MyMessage, name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::MyMessage, id_),
};
...
MyMessage::MyMessage()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_Base_2eproto::scc_info_MyMessage.base);
  SharedCtor();
...
const MyMessage& MyMessage::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_Base_2eproto::scc_info_MyMessage.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::MyMessage* Arena::CreateMaybeMessage< ::MyMessage >(Arena* arena) {
